    ...
    <div class="app-welcome">
        <div class="concord">
            <div class="header">
                ...
                <div class="account">
                    <button class="btn-sign-in" id="btn-sign-in"><a href="login.php" style="color: #fff;
    text-decoration: none;">Sign In</a></button>
                    <button class="btn-sign-up" id="btn-sign-up"><a href="login.php" style="color: #fff;
    text-decoration: none;">Sign Up</a></button>
                </div>
            </div>
